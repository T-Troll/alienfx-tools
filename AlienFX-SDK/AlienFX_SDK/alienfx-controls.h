...
namespace AlienFX_SDK {
	...
	static struct COMMV8 {
		const byte status[2]{0x5,0x1};
		//const byte control[13]{0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x0a,0x00,0x01,0x01};
		const byte control[14]{0x5,0x01,0xff,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x0a,0x00,0x02,0x01};
	...
	static struct COMMV9 {
		...
		// [3] - effectID (0x13 - color reset, 2,3,7,8,0 - other)
		// [4-6] - RGB1
		// [7-9] - RGB2
		// [10] - tempo
		// [14] - NumColors (0..3)?
		const byte readyToColor[4]{ 0xe,0x1,0x0,0x1 };
		// [2] - how much lights (1..4)
		...
		// [14-16] - RGB2
		// [18] - Number of RGB
		// [20-33],[35-48],[50-63] - same block (at least 2 first)
