...
namespace AlienFX_SDK {
	...
	// V8, external keyboards
		...
		// [6..8] - rgb
		// block [5-8] repeated
		const byte COMMV8_effectReady[]{4, 0x5,0x0,0x51,0}; // Select profile, in fact!
		// [2] - profile number
		const byte COMMV8_effectSet[]{2, 0x5,0x0/*,0x13,0x00,0xf0,0xf0,0x00,0x00,0x00,0x10,0x0a,0x00,0x01,0x01 */ };
		// [2] - profile number
