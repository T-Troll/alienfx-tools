...
namespace LFXUtil
{
	...
	class LFXUtilC
	{
		...
		public:
			...
			int SetOneLFXColor(unsigned dev, unsigned light, PLFX_COLOR color);
			int SetLFXAction(unsigned action, unsigned dev, unsigned light, PLFX_COLOR color, PLFX_COLOR color2);
